			...
			<div class="table">
				<div style="height: 50px; padding-left: 200px; width: 500px;">
					<label>Search Element <input type="text"
						data-ng-model="search" data-ng-init="search='${param.item}'"></label>
				</div>
				<br>
				<center>
					...
					<table id="myTable">
						...
						<c:if test="${not empty products}">
							...
							<c:forEach var="my" items="${products}">
								 <tr data-ng-repeat="search in products | filter:searchText">
									...
									<a href="<spring:url value="/products?productId=${my.productId }" />"
